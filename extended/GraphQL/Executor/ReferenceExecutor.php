...
class ReferenceExecutor implements ExecutorImplementation
{
    ...
    protected function executeFields(ObjectType $parentType, $rootValue, array $path, ArrayObject $fields)
    {
        ...
        foreach ($fields as $responseName => $fieldNodes) {
            ...
            $isSubscription = $parentType->config['name'] === 'Subscription';
            $result      = $isSubscription ? fn() => $this->resolveField($parentType, $rootValue, $fieldNodes, $fieldPath) :
                $this->resolveField($parentType, $rootValue, $fieldNodes, $fieldPath);
